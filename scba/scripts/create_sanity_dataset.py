...
def main():
    ...
    jsrt_source = Path(args.jsrt_source or os.environ.get("SCBA_JSRT_ROOT", ""))
    ...
    montgomery_source = Path(args.montgomery_source or os.environ.get("SCBA_MONTGOMERY_ROOT", ""))
