    ...
    def explain(
        ...
        **kwargs,
        ...
        for i in tqdm(range(n_batches), desc="RISE"):
            ...
            # Scientific justification: aggressive GPU memory cleanup for large-scale experiments
            # Clear tensors immediately and synchronize before cache clear
            del batch_masks_t, masked_images, outputs, scores
            if self.device.type == "cuda":
                torch.cuda.synchronize()  # Ensure all ops complete before cleanup
